...
export default function Floating() {
    ...
    return (
        ...
        scale-75 md:scale-100 origin-bottom-left"
            ...
            <div className={`z-50 bottom-4 right-4 origin-bottom-right ${process.env.NODE_ENV == "development" ? "fixed" : "hidden"}`}><span>version {process.env.NEXT_PUBLIC_VERSION}</span></div>
        </>
    );
}
