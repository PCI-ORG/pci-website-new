...
const SITEMAP = [
    {
        title: "About",
        links: ["About Us", "Research & Data", "Media", "Presentations", "Newsletter"],
    },
    {
        title: "Projects",
        links: ["PCI-China", "PCI-Crackdown", "PCI-Personnel", "PCI-Outbreak", "PCI-NKO"],
    },
...
export default function Footer() {
    return (
        <footer className="relative w-full bg-pciEbony">
